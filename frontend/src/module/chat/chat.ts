...
class Chat {
  ...
  // curl "http://parking-dev.api.patternx.gemdale.com/socket.io/?EIO=4&transport=polling"
  // socketHost = 'https://app-dev.patternx.gemdale.com/?roomId=room1023&userId=user0001';
  socketHost = 'http://localhost:9107/?roomId=room1023&userId=user0001';
